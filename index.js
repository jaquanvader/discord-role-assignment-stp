...
function welcomeDM(userId) {
  return [
    ...
    ``,
    `💎 **VIP section**`,
    `• Access our **highest-performing handicappers**`,
...
function expiredDM(userId) {
  return [
    ...
    ``,
    `Access to the **highest-performing, highest-ROI handicappers** is now locked.`,
    ``,
    `You’ll still see the free picks — but VIP is where the`,
...
function noTrialDM(userId) {
  return [
    ...
    ``,
    `You can still view the free picks, but the`,
    `**highest win-rate and highest-ROI handicappers** are VIP-only.`,
    ``,
